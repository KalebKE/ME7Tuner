...
public class PrimaryFuelingMe7LogUiManager {
    ...
    public PrimaryFuelingMe7LogUiManager() {
    ...
    private JButton getConfigureFilterButton() {
        ...
        button.addActionListener(e -> {
            PrimaryFuelingMe7LogFilterConfigPanel filterConfigPane = new PrimaryFuelingMe7LogFilterConfigPanel ();
                ...
                for (PrimaryFuelingMe7LogFilterConfigPanel.FieldTitle fieldTitle :PrimaryFuelingMe7LogFilterConfigPanel.FieldTitle.values()) {
                    switch (fieldTitle) {
                        ...
                        case NUM_METHANOL_NOZZLES:
                            PrimaryFuelingPreferences.setNumMethanolNozzlePreference(Integer.valueOf(filterConfigPane.getFieldText(fieldTitle)));
                            break;
                    }
                }
