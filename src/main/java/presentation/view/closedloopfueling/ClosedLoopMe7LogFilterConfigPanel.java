        ...
        for (int i = 0; i < FieldTitle.values().length; i++) {
            ...
            switch (fieldTitle) {
                case MIN_THROTTLE_ANGLE:
                    ...
                    textField.setValue(ClosedLoopFuelingLogPreferences.getMinThrottleAnglePreference());
                    break;
                case MIN_RPM:
                    textField = new JFormattedTextField(integerFormatter);
                    textField.setValue(ClosedLoopFuelingLogPreferences.getMinRpmPreference());
                    break;
                case MAX_VOLTAGE_DT:
                    textField = new JFormattedTextField(decimalFormatter);
                    textField.setValue(ClosedLoopFuelingLogPreferences.getMaxVoltageDtPreference());
                    break;
            }
