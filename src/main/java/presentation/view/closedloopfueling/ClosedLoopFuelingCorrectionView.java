...
import presentation.viewmodel.closedloopfueling.ClosedLoopFuelingCorrectionViewModel;
...
public class ClosedLoopFuelingCorrectionView {
    ...
    private void initMlhfmChart() {
        ...
        mlfhmChart.getTitle().setPaint(Color.decode("#F8F8F2"));
        mlfhmChart.setBackgroundPaint(Color.decode("#383c4a"));
        mlfhmChart.getLegend().setBackgroundPaint(Color.decode("#383c4a"));
        mlfhmChart.getLegend().setItemPaint(Color.decode("#F8F8F2"));
    ...
    private void initStdDevChart() {
        ...
        stdDevChart.getTitle().setPaint(Color.decode("#F8F8F2"));
        stdDevChart.setBackgroundPaint(Color.decode("#383c4a"));
        stdDevChart.getLegend().setBackgroundPaint(Color.decode("#383c4a"));
        stdDevChart.getLegend().setItemPaint(Color.decode("#F8F8F2"));
    ...
    private void initAfrCorrectionChart() {
        ...
        afrCorrectionChart.getTitle().setPaint(Color.decode("#F8F8F2"));
        afrCorrectionChart.setBackgroundPaint(Color.decode("#383c4a"));
        afrCorrectionChart.getLegend().setBackgroundPaint(Color.decode("#383c4a"));
        afrCorrectionChart.getLegend().setItemPaint(Color.decode("#F8F8F2"));
        ...
        correctionPointRenderer.setSeriesPaint(0, Color.decode("#f57900"));
