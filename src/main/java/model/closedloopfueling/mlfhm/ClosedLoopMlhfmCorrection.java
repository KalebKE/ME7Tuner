...
public class ClosedLoopMlhfmCorrection {
    ...
    public ClosedLoopMlhfmCorrection(Map2d inputMlhfm, Map2d correctedMlhfm, Map2d fitMlhfm, Map<Double, List<Double>> filteredVoltageDt, Map<Double, List<Double>> correctionsAfrMap, Map<Double, Double> meanAfrMap, Map<Double, double[]> modeAfrMap, Map<Double, Double> correctedAfrMap) {
