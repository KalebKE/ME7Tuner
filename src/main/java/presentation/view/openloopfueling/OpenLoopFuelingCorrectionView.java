...
import presentation.viewmodel.openloopfueling.OpenLoopFuelingCorrectionViewModel;
...
public class OpenLoopFuelingCorrectionView {
    ...
    private void initAfrCorrectionChart() {
        ...
        afrCorrectionPointRenderer.setSeriesPaint(0, Color.decode("#f57900"));
            ...
            if (returnValue == JFileChooser.APPROVE_OPTION) {
                ...
                if(table != null) {
                    ...
                    if(tableDefinition != null) {
                        ...
                        if(file != null) {
                            try {
                                BinWriter.getInstance().write(file, tableDefinition, openLoopMlhfmCorrection.fitMlhfm);
