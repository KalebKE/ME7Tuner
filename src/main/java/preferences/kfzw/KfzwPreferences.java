...
public class KfzwPreferences {

    private static final String TABLE_TITLE_PREFERENCE = "kfzw_title_preference";
    private static final String TABLE_DESCRIPTION_PREFERENCE = "kfzw_description_preference";

    private static final Preferences prefs = Preferences.userNodeForPackage(KfzwPreferences.class);
