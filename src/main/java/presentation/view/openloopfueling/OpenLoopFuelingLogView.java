...
public class OpenLoopFuelingLogView {
    ...
    private void initFuelingChart() {
        ...
        fuelingChart.getTitle().setPaint(Color.decode("#F8F8F2"));
        fuelingChart.setBackgroundPaint(Color.decode("#383c4a"));
        fuelingChart.getLegend().setBackgroundPaint(Color.decode("#383c4a"));
        fuelingChart.getLegend().setItemPaint(Color.decode("#F8F8F2"));
        ...
        rendererMe7.setDefaultPaint(Color.decode("#f57900"));
    ...
    private void initAirflowChart() {
        ...
        rendererMeasured.setDefaultPaint(Color.decode("#f57900"));
